...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // When registering, store the email in Session Storage
        ...
        <section>
            ...
            <div className="username">
                ...
                <label htmlFor="confirm_email">
                    Confirm Email:
                    <span className={validEmailMatch && email.length !==0 ? "valid" : "hide"}>
                        <FontAwesomeIcon icon={faCheck} />
                    </span>
                ...
                <label htmlFor="confirm_pwd">
                    Confirm Password:
                    <span className={validMatch  && pwd.length !== 0 ? "valid" : "hide"}>
                        <FontAwesomeIcon icon={faCheck} />
                    </span>
                ...
                <button   className='registerbutton' disabled={!validName || !validPwd || !validMatch ? true: false}>
                    Sign Up
                </button>
                <p>
